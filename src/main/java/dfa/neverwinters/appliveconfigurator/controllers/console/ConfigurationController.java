...
import dfa.neverwinters.appliveconfigurator.process.console.ConfigurationProcess;
...
/**
 * <p>ConfigurationController</p>
 * <p>Configuration page controller class.</p>
 */
@Controller
@RequestMapping("${definitions.console.path}")
public class ConfigurationController implements WebMvcConfigurer
{
    ...
    @GetMapping("${definitions.console.configuration.path}")
    ...
    @PostMapping("${definitions.console.configuration.path}")
